<template>
  <div class="service-search-container bg-poseidon-50 p-6 rounded-lg shadow-sm">
    <h2 class="text-2xl font-bold text-poseidon-700 mb-6">尋找潛水服務</h2>
    ...
    <div class="search-box relative mb-6">
      <input
        ...
        class="w-full py-3 px-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-poseidon-500"
      />
    ...
    <div class="filter-section mb-6">
      <div
        class="filter-header flex items-center justify-between mb-4"
        ...
        <div class="filter-group">
          ...
          <div class="relative">
            ...
            >
              ...
              <option v-for="exp in experienceLevels" :key="exp.id" :value="exp.id">
                {{ exp.name }}
              </option>
            </select>
            <div class="absolute right-3 top-1/2 transform -translate-y-1/2 pointer-events-none">
    ...
    <!-- 搜尋按鈕 -->
    <button
      class="w-full py-3 bg-poseidon-500 text-white rounded-lg flex items-center justify-center hover:bg-poseidon-800 transition-colors"
